    ...
    <div class="felx justify-center">
        <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
            <div class="w-8/12 lg:w-6/12 px-5">
                <p><img src="{{ $user->imagen ? asset('perfiles') . "/" . $user->imagen : asset('img/usuario.svg')  }}" alt="{{ $user->username }}" /></p>
            </div>
            <div class="md:w-8/12 lg:w-6/12 px-5 flex flex-col items-center py-10 md:justify-center md:items-start">

                <div class="flex items-center gap-2">
                    <p class="text-gray-700 text-2xl">username: {{ $user->username }}</p>  
                    @auth
